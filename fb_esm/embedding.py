...
class BERTEmbeddingConv(nn.Module):
    def __init__(self, vocab_size, embed_size, padding_idx=0,dropout=0.1,max_len=512,pos='sin'):
        super().__init__()
        highway_layers = 1

        onehot_dim = vocab_size-1
        self.onehot = nn.Embedding(vocab_size,onehot_dim,padding_idx=padding_idx)
...
class BERTEmbeddingConvESM(nn.Module):
    def __init__(self, vocab_size, embed_size, padding_idx=0,dropout=0.1,max_len=512,pos='sin'):
        super().__init__()
        highway_layers = 1
